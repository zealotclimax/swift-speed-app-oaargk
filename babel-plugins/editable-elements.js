...
const { PAGES_PATH, EDITABLE_ELEMENTS, isIconElement, isImageElement } = require("./config.js");
...
const wrapElementsInEdit = (t, path, state) => {
  ...
  // Check if element is in the editable list OR is an icon/image component
  const isEditable = EDITABLE_ELEMENTS.includes(elementName) || 
